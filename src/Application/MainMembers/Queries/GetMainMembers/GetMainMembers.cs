...
public class GetMainMembersQueryValidator : AbstractValidator<GetMainMembersQuery>
{
    public GetMainMembersQueryValidator()
    {
    }
}
...
public class GetMainMembersQueryHandler : IRequestHandler<GetMainMembersQuery, Result<List<MainMemberResponse>>>
{
    ...
    public async Task<Result<List<MainMemberResponse>>> Handle(GetMainMembersQuery request, CancellationToken cancellationToken)
    {
        ...
        return Result.Success(mainMembers);
    }
}
