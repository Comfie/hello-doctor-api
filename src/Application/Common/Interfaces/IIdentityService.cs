...
public interface IIdentityService
{
    ...
    Task<Result<AuthResponse>> AuthenticateUserAsync(string username, string password,
    ...
    Task<Result<bool>> ResetPasswordAsync(UpdateUserPasswordRequest updateUserPasswordRequest,
        CancellationToken cancellationToken = default);
