        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PharmaciesId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastIssuedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    Created = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    LastModified = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "text", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OneTimePins", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OneTimePins_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pharmacists_AspNetUsers_AccountId",
                        column: x => x.AccountId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FileUploads_Prescriptions_PrescriptionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferencedItemId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrescriptionNotes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PrescriptionNotes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PrescriptionStatusHistories_AspNetUsers_ChangedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FileUploads_PrescriptionId",
                table: "FileUploads",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OneTimePins_UserId",
                table: "OneTimePins",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Pharmacists_AccountId",
                table: "Pharmacists",
                column: "AccountId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrescriptionNotes_UserId",
                table: "PrescriptionNotes",
                column: "UserId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrescriptionStatusHistories_ChangedByUserId",
